...
public class Customer {
    ...
    public Customer(String id, String firstName, String lastName, String firstLineAdd, String secondLineAdd,
    ...
    public Customer(String setFirstname, String setLastname, String setVReg, String setVName)
    {   
        this.firstName = new SimpleStringProperty(setFirstname);
        this.lastName = new SimpleStringProperty(setLastname);  
        this.vReg = new SimpleStringProperty(setVReg);
        this.vMake = new SimpleStringProperty(setVName);
    }
